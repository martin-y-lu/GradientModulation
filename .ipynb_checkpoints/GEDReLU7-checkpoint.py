...
class GEDReLUFunction(torch.autograd.Function):
    ...
    def backward(ctx, grad_output):
        ...
        # if torch.sum(S_n_c*Gi) < 0:
        #     gated_eventual_input = torch.zeros_like(input)
        ...
        return grad_input + gated_eventual_input, grad_S_n_n, grad_S_n_p, grad_input , None, None, None, None
